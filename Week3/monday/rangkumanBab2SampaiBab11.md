...
* jika komentarnya hanya satu baris maka sebelum menulis pake tanda ( // ) *contoh:* // saya membuat looping angka disini.
* jika komentarnya banyak ( lebih dari satu baris ) maka menggunakan tanda ( /* ) sebagai pembuka dan ( */ ) sebagai penutup komentar. *contohnya:* ( tanya google).
